...
public class CategoryController {
	...
	public ResponseEntity<ResponseDTO<CategoryDTO>> list(@RequestBody SearchCategoryDTO searchCategoryDTO) {
		...
		responseDTO.setRecordsFiltered(categoryService.countTotal(searchCategoryDTO));
	...
	public @ResponseBody CategoryDTO add(@RequestBody CategoryDTO syllabusDTO) {
		categoryService.add(syllabusDTO);
		return syllabusDTO;
	}

	@PutMapping("/category/update")
	public @ResponseBody CategoryDTO updateDictionary(@RequestBody CategoryDTO syllabusDTO) {
		categoryService.update(syllabusDTO);
		return syllabusDTO;
	}
}
